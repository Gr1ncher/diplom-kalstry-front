...
const StyledBtn = styled.button<StyledBtnProps>(
  ({ theme, variant, fullSize }) => {
    return {
      backgroundColor: variant === 'primary' ? theme.palette.primary.default : theme.color.white,
      padding: '1rem 2rem',
      borderRadius: 10,
      ...
      '&:hover': {
        backgroundColor: variant === 'primary' ? theme.palette.primary.hover : theme.color.mainPurple,
        color: variant === 'primary' ? 0 : theme.color.white,
      },
      '&:active': {
        backgroundColor: variant === 'primary' ? theme.palette.primary.active : theme.color.white,
        transform: 'translateY(2px)',
      },
      '&:disabled': {
        backgroundColor: variant === 'primary' ? theme.colors.lightWhite : theme.color.white,
        color: variant === 'primary' ? theme.palette.primary.disabled : theme.color.mainPurple,
      },
    };
  },
  space,
